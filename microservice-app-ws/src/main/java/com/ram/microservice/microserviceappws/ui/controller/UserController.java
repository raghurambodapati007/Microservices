package com.ram.microservice.microserviceappws.ui.controller;
...
import com.ram.microservice.microserviceappws.ui.model.request.UpdateUserDetailsRequestModel;
...
public class UserController {
	...
	public String getUsers(@RequestParam(value="page" , defaultValue="1", required=false) int page,
					       ...
					       @RequestParam(value="sort", defaultValue="description", required = false) String sort) {
	...
	public UserRest updateUser(@PathVariable String userId,@Valid @RequestBody UpdateUserDetailsRequestModel UpdateuserDetails) {
		...
		storedDetails.setFirstName(UpdateuserDetails.getFirstName());
		storedDetails.setFirstName(UpdateuserDetails.getLastName());
